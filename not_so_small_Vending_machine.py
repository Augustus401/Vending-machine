#welcome to not so small Vending machine coding 
#I made a class for the Vending machine
...
#it will show or display the menu or the products and the welcome
...
#To give the amount to the machine 
...
#To make the user to select the product they want
